...
public class TrainingReportsControllerTest {
    ...
    void getMonthlyReports_WhenNoReportsFound_ShouldReturnEmptyList() throws Exception {
        ...
        when(trainingReportsService.getMonthlyReports(idLearner, month, year))
                .thenReturn(Collections.emptyList());

        mockMvc.perform(MockMvcRequestBuilders.get("/api/training-reports/monthly-reports/{idLearner}/{month}/{year}", idLearner, month, year)
